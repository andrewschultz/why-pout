...
mynum	flipnpcs	mytext
0	--	"[t1t2] discuss the plusses and minuses of the Aim-Own-a-Moan method of taking control of one's destiny."
0	--	"[t1t2] point out how [i]Tude: Rips to Drips![r], as life advice, is too Machiavellian and zero-sum."
0	--	"[t1t2] agree the Curb-It-Cur Bit is an effective method for assertively shutting down trolls without going too far."
0	--	"[t1t2] laugh over the guilt they feel liking the protagonist of [i]Rock On, Raw Con[r]."
0	--	"[t1t2] have nothing but praise for the comedy sketch [i]Be Fly! Beef! Lie![r]"
0	--	"[t1t2] note one can't help but love the cartoonishly overdone [i]The Grow-Thug Row[r]."
0	--	"[t1t2] note logical fallacies, sneaky or not, of the 'down-home wisdom' of [i]Thus Collar the Scholar[r]."
0	--	"[t1t2] agree the pessimism of [i]Aye, Sage, Ice Age[r] is unfounded."
0	--	"[t1t2] discuss which of [i]Thaw, Tiresome Thought, Iresome[r] and [i]Thaw: Taxing Thought Axing[r] was plagiarized from the other."
0	--	"[t1t2] rave unironically about the peace found on the [i]Fight-Rail-Fie?! Trail[r]."
0	--	"[t1t2] laugh at how [i]A Tank's Eight Ankhs[r] skewers how war and organized religion play off each other."
0	--	"[t1t2] debate the (unrevealed) flavor of [i]The Spy-Thus Pie[r]."
0	--	"[t1t2] peg [i]A Fold of Old[r] as too-kistchy historical fiction."
0	--	"[t1t2] disagree on interpretations of the fable [i]Slow Poke Slope Oak[r]."
0	--	"[t1t2] have surprisingly sophisticated opinions of the musical documentary [i]Too Nice Tune, Ice[r]."
0	--	"[t1t2] mock the preachiness of [i]He Did Heed Id[r]."
0	--	"[t1t2] trade gruesome stories about the quasi-mythical Clamp-It Clam Pit."
0	--	"[t1t2] discuss high-tech conveniences. 'THESE apps?! The saps!'"
0	--	"[t1t2] compare how much they remember from the gangsta rap track [i]Thug [']Round The Ground[r]. More than tunes they like, alas."
0	--	"[t1t2] resolve to visit the Raw Mental Ramen Till for fine dining once this is over."
0	--	"[t1t2] agree the blockbuster romcom tearjerker [i]Aid of a Dove[r] was much too sappy."
0	--	"[t1t2] agree on a fun new place to relax once this is over: Aw-Flake-Off Lake."
0	--	"[t1t2] discuss whether the bawdy comedy [i]Ace Ain't a Saint[r] goes too far."
0	--	"[The t1] chides [the t2]: '[i]Zoom, Eat Zoo Meat[r] was meant to be a SATIRE. You missed it!'"
0	--	"[t1t2] find [i]Law, Start Lost Art[r] too anarchic and nihilistic."
0	--	"[t1t2] dissect the pseudo-philosophical tratise [i]Wail, or Weigh Lore[r]."
0	--	"[t1t2] break down the over-loud 'talk show' [i]My Take Might Ache[r]."
0	--	"[t1t2] discuss rueful hard lessons learned: 'Sly may slime, eh?'"
0	--	"[t1t2] mock the didactic [i]WE duck weed, uck[r] while mentioning they keep THEIR noses clean."
0	--	"[t1t2] dream of vaationing at Dune Eat-Do-Neat." [e]
0	--	"[t1t2] shudder at the horror film [i]Tomb Urge To Merge[r]."
0	--	"[t1t2] find [i]Oh, Great Ogre Ate[r] a bit overdone."
0	--	"[t1t2] discuss pop culture. 'Star Trek: start? Rec!'"
0	--	"[t1t2] realize they've been monopolizing the chatter a bit. 'We so wheeze, oh!'"
0	--	"[t1t2] are surprised to discover a mutual affinity for the concept album [i]A Toad's Eight Odes[r]."
0	--	"[t1t2] discuss how the cases and plots on [i]Jade E, J.D.[r] have gotten increasingly convoluted."
0	--	"[t1t2] both can't believe they once liked that podcast: [i]The Dour THUD Hour[r]."
0	--	"[t1t2] laugh at quotes from the classic buddy-cop movie [i]Thug Eyes the Guys[r]."
0	--	"[t1t2] bemoan the schtick of the Hype-Up-High Pup."
0	--	"[t1t2] note clever design choices in the simple game [i]Thus Nail the Snail[r]."
0	--	"[t1t2] yawn over the historical fiction [i]See Quill Seek Will[r]. Thankfully, it had no, well, sequel."
0	--	"[t1t2] argue whether [i]The Swirled-Thus World[r] is more escapism or dystopia."
0	--	"[t1t2] show horror at the psychological thriller [i]The Facts Thief Acts[r]."
0	--	"[t1t2] nitpick unrealistic details in the thriller [i]Four Stop Forced Op[r]."
0	--	"[t1t2] debate how bigoted [i]Gnome, Aid No Maid[r] really is."
0	--	"[t1t2] discuss certain folks who belong on the [i]Know-piles?-NOPE Isles[r]."
0	--	"[t1t2] discuss the simple and effective horror of [i]Gray Vile Grave Isle[r]."
0	--	"[t1t2] unravel the effective faux optimism of [i]My Leased Mile East[r]."
0	--	"[t1t2] proclaim the Soak-You-So Queue the best water-themed amusement park ride ever!"
0	--	"[t1t2] analyze the warnings and cautious optimism of [i]Thaw, Teach Thought, Each[r]."
0	--	"[t1t2] argue whether robust optimism hides beneath the surface of [i]Thus Know the Snow[r]."
0	--	"[t1t2] wonder how anyone could find [i]It sprays its praise, It swings its wings[r] profound."
0	--	"[t1t2] discuss bringing up a zoo map on a Zoom App."
0	--	"[t1t2] pick apart how and why [i]Blow Trust, Bloat, Rust[r] is heavy-handed."
0	--	"[t1t2] discuss how the allegedly heartwarming family comedy [i]My Two Might, Ooh[r] gives them heartburn, actually."
0	--	"[t1t2] note the ways the tear-jerker [i]We Vow-Weave, Ow[r] caused tears of laughter."
...
0	--	"[t1t2] are surprised to note how much they miss Stale Mist Ale." [e]
